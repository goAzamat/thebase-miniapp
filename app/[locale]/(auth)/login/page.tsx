 ...
 * -------------------------------------------------------------
 * Premium sign-in screen for THE BASE portal.
 *
 * Flow: collect email + Odoo password → signIn('odoo', { redirect:false })
 * → on success push to the original callbackUrl (or the user's home, which
 * the dashboard root resolves to their default module).
 *
 * Pure client component: state, inline errors and pending UI live here; the
 * actual credential check happens server-side in the Auth.js Node route.
 */
        ...
        <div className="rounded-2xl border border-[#352a20] bg-[#211a14]/80 p-8 shadow-2xl backdrop-blur-sm">
          ...
          <form onSubmit={onSubmit} className="space-y-4" noValidate>
            ...
            <label className="block">
              <span className="mb-1.5 block text-xs font-medium text-[#b6a895]">
                {t('email')}
              </span>
